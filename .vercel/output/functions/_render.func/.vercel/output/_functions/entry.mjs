...
const _page3 = () => import('./pages/build.astro.mjs');
const _page4 = () => import('./pages/categoria.astro.mjs');
const _page5 = () => import('./pages/listaproductos/funebres.astro.mjs');
const _page6 = () => import('./pages/listaproductos/paquetes.astro.mjs');
const _page7 = () => import('./pages/listaproductos/telemedicina.astro.mjs');
const _page8 = () => import('./pages/nosotros.astro.mjs');
const _page9 = () => import('./pages/products/_id_.astro.mjs');
const _page10 = () => import('./pages/servicios/asistenciavial.astro.mjs');
const _page11 = () => import('./pages/servicios/funerario.astro.mjs');
const _page12 = () => import('./pages/servicios/rcv.astro.mjs');
const _page13 = () => import('./pages/servicios/telemedicina.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/Build.astro", _page3],
    ["src/pages/categoria.astro", _page4],
    ["src/pages/listaProductos/funebres.astro", _page5],
    ["src/pages/listaProductos/paquetes.astro", _page6],
    ["src/pages/listaProductos/telemedicina.astro", _page7],
    ["src/pages/nosotros.astro", _page8],
    ["src/pages/products/[id].astro", _page9],
    ["src/pages/servicios/AsistenciaVial.astro", _page10],
    ["src/pages/servicios/funerario.astro", _page11],
    ["src/pages/servicios/RCV.astro", _page12],
    ["src/pages/servicios/telemedicina.astro", _page13],
...
const _args = {
    "middlewareSecret": "31a4db99-10ab-493f-91fe-b404e09098fd",
